...
public class MapActivity extends BaseActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getExtras()!=null){
            classReference = getIntent().getStringExtra(Constants.KEY_CLASS_REFERENCE);
        }
        ...
        if (NetworkUtil.isConnected(mContext)){
            try {
                if (classReference!=null){
                    Log.e("classReference",classReference);
                    Intent intent= new Intent();
                    intent.putExtra(Constants.KEY_CITY,mStateOutput);
                    intent.putExtra(Constants.KEY_LATITUDE,mCenterLatLong.latitude);
                    intent.putExtra(Constants.KEY_LONGITUDE,mCenterLatLong.longitude);
                    setResult(RESULT_OK,intent);
                    finish();
                }else {
                    Intent navigationIntent = new Intent(MapActivity.this, NavigationDrawerActivity.class);
                    navigationIntent.putExtra(Constants.KEY_LATITUDE,mCenterLatLong.latitude);
                    navigationIntent.putExtra(Constants.KEY_LONGITUDE,mCenterLatLong.longitude);
                    startActivity(navigationIntent);
                    finishAffinity();
                }
            } catch (Exception e) {
                Toast.makeText(mContext, "Waiting for the location", Toast.LENGTH_SHORT).show();
                e.printStackTrace();
            }
        }else
            Toast.makeText(mContext, R.string.no_internet, Toast.LENGTH_SHORT).show();
        ...
        mMap.setOnCameraChangeListener(new GoogleMap.OnCameraChangeListener() {
            ...
            public void onCameraChange(CameraPosition cameraPosition) {
                ...
                try {
                    ...
                    Log.e("camera location lat : ", String.valueOf(mCenterLatLong.latitude));
                    Log.e("camera location lng : ", String.valueOf(mCenterLatLong.longitude));
        ...
        if (requestCode == REQUEST_CODE_AUTOCOMPLETE) {
            if (resultCode == RESULT_OK) {
                ...
                if (place!=null){
                    ...
                    if (data.getStringExtra(Constants.KEY_SET_CURRENT_LOCATION)!=null){
